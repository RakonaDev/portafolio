  ...
  return (
    <>
      <div className="container font-k2d main-container">
        ...
        >
          <ul
            className="d-flex mt-3 list gap-5 p-3 rounded-4 fw-bold navbar-container"
            id="navbar"
          >
            <li className="fs-6 list-item" onClick={() => scroll("sobre-mi")}>
              Sobre Mi
            </li>
            <li className="fs-6 list-item" onClick={() => scroll("proyectos")}>
              Proyectos
            </li>
            <li className="fs-6 list-item" onClick={() => scroll("contacto")}>
              Certificaciones
            </li>
          </ul>
        </motion.header>
        ...
        <section className="w-100 row-gap-4" style={{ marginTop: "80px" }}>
          <div
            className="d-flex flex-wrap align-items-center yo-container pt-5"
            id="sobre-mi"
          >
            <div style={{ width: "50%" }} className="name-container">
              ...
              <motion.p
                ...
                transition={{ duration: 0.7 }}
                viewport={{ once: false }}
                className="text-justify fw-medium fs-3 name-text"
                id="nombre"
              >
          ...
          <nav className="redes mt-3 d-flex flex-wrap gap-3 align-items-center">
            ...
            <a
              href={MiCV}
              download="JuanCarlosCajas-CV.pdf"
              className="list-item d-flex gap-2 justify-content-center align-items-center"
            >
        ...
        <main className="w-100" style={{ marginTop: "150px" }}>
          ...
          <p className="mt-4 fs-6 text-white">
            ...
            , ando desarrollando proyectos web desde 2023. Mi objetivo es
            mejorar mi conocimiento y habilidades en el desarrollo web, y me
            interesa aprender nuevas tecnologías y metodologías para mejorar mi
            trabajo.
          </p>
          <motion.h1
            initial={{ opacity: 0, transform: "translateX(-100px)" }}
            ...
            transition={{ duration: 0.7 }}
            viewport={{ once: false }}
            className="fs-1 fw-bold mt-5 text-primary"
          >
            <span className="me-3">
            ...
            <li className="d-flex container flex-wrap gap-5">
              ...
              <div style={{ width: "60%" }} className="body-text">
                <p className="text-justify">
                  ...
                  educativa. Administré el desarrollo tanto frontend como
                  backend, y logré darle solución al problema.
                </p>
              </div>
            </li>
          </ol>
        ...
        <section className="pt-5" id="proyectos">
          ...
          <ul className="mt-5 proyect-container">
            ...
            <motion.li
              ...
              className="d-flex justify-content-evenly gap-2 proyect-item flex-wrap"
            >
              <img
                src={Zaitex}
                alt="zaitex"
                className="proyecto-foto object-fit-contain"
              />
              <div className="proyect-body">
                ...
                <p style={{ height: "110px" }}>
                  ...
                  login para los estudiantes matriculados para que entren al
                  panel de estudiante.
                </p>
                <a
            ...
            <motion.li
              ...
              transition={{ duration: 0.7 }}
              viewport={{ once: false, amount: 0.2 }}
              className="d-flex justify-content-evenly gap-2 mt-4 proyect-item flex-wrap"
            >
              <img
                src={Raiki}
                alt="raiki"
                className="proyecto-foto object-fit-cover"
              />
              <div className="proyect-body">
                ...
                <p style={{ height: "110px" }}>
                  Landing Page para Raiki para mostrar los servicios de branding
                  y diseño web que otorgan a los clientes. Construido con React
                  y con constante mantenimiento.
                </p>
                <a
            ...
            <motion.li
              ...
              transition={{ duration: 0.7 }}
              viewport={{ once: false, amount: 0.2 }}
              className="d-flex justify-content-evenly gap-2 proyect-item mt-4 flex-wrap"
            >
              <img
                src={ShortUrl}
                alt="zaitex"
              ...
              <div className="proyect-body">
                ...
                <p style={{ height: "110px" }}>
                  Proyecto personal que sirve para acortar un url y que se pueda
                  compartir con otros. Este proyecto nació para poner en
                  práctica mi lógica y aprender a usar springboot y angular.
                </p>
                <a
            ...
            >
              ...
              <div className="proyect-body">
                ...
                <p style={{ height: "100px" }}>
                  Proyecto personal que sirve para aprender a usar una api de un
                  fake store que son pedidos de un servidor para que sea lo más
                  real posible. Esta idea nació para ayudar a la comunidad de
                  desarrolladores que quieran conectar sus paginas web a un
                  servidor.
                </p>
        ...
        <section className="w-100 pt-5" id="contacto">
          <motion.h1
            ...
            transition={{ duration: 0.7 }}
            viewport={{ once: false }}
            className="text-primary fs-1 fw-bold"
          >
